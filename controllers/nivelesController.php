...
switch ($option) {
    ...
    case 'save':
        ...
        if ($id_nivel == '') {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'POBLACION REGISTRADO');
                } else {
                    $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL AGREGAR');
                }
            } else {
                $res = array('tipo' => 'error', 'mensaje' => 'LA POBLACION YA EXISTE');
            }
        } else {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'POBLACION MODIFICADO');
                } else {
    ...
    case 'delete':
        ...
        if ($data) {
            $res = array('tipo' => 'success', 'mensaje' => 'POBLACION ELIMINADO');
        } else {
