...
switch ($option) {
    ...
    case 'save':
        ...
        if ($id_carrera == '') {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'SERVICIO REGISTRADO');
                } else {
                    $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL AGREGAR');
                }
            } else {
                $res = array('tipo' => 'error', 'mensaje' => 'EL SERVICIO YA EXISTE');
            }
        } else {
            ...
            if (empty($consult)) {
                ...
                if ($result) {
                    $res = array('tipo' => 'success', 'mensaje' => 'SERVICIO MODIFICADO');
                } else {
    ...
    case 'delete':
        ...
        if ($data) {
            $res = array('tipo' => 'success', 'mensaje' => 'SERVICIO ELIMINADO');
        } else {
