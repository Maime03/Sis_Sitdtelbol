...
<head>
   ...
   <title>Registro de Servicio Tecnico</title>
    ...
    <div class="masthead">
        <div class="masthead-content text-white">
            <div class="container-fluid px-lg-0">
                ...
                <h1 class="fst-italic lh-1 mb-4">Sistema de servicio tecnico SITDTELBOL</h1>
                <p class="mb-5">Solicitar Servicio Tecnico</p>
                <form id="contactForm" autocomplete="off">
                    <!-- Email address input-->
                    <div class="row input-group-newsletter">
                        <div class="col"><input class="form-control" id="codigo" name="codigo" type="text" placeholder="Ingrese código de cliente" /></div>
                        <div class="col-auto"><button class="btn btn-primary" id="submitButton" type="submit">Registrar Solicitud</button></div>
                        
                    </div>
                    <div class="row input-group-newsletter">
                        <div class="col"><input class="form-control" id="salida" name="salida" type="text" placeholder="Describa el problema del servicio" /></div>
