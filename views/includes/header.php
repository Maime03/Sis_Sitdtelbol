...
<head>
  ...
  <title>Menu principal</title><!-- Control de asistencia -->
  <!-- base:css -->
      ...
      <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="?pagina=niveles">
            ...
            <span class="menu-title">Poblacion</span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="?pagina=asistencia">
            ...
            <span class="menu-title">Solicitudes Asistencias</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="?pagina=carreras">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <div class="navbar-brand-wrapper">
            <a class="navbar-brand brand-logo" href="plantilla.php"><img src="<?php echo RUTA . 'assets/'; ?>images/logo.png" width="100" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="plantilla.php"><img src="<?php echo RUTA . 'assets/'; ?>images/logo.png" width="80" alt="logo"/></a>
          </div>
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">BIENVENIDO AL SISTEMA DE REGISTRO Y CONTROL DEL SERVICIO TÉCNICO</h4>
